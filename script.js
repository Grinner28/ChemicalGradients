...
const instructionSections = [
    "Welcome to the Chemical Gradient explorer where, you can test your understanding of chemical gradients.",
    "Above is a cell and it's inner and outer Na+ ion concentrations.",
    "Determine the direction of the chemical gradient by selecting one of the options: 'Into the cell', 'Out of the cell', or 'At equilibrium'",
    "After each submission, you'll receive feedback based on your response",
    "To explore different scenarios, simply click the 'New Question' button, and the Na+ ion concentrations will be updated.",
